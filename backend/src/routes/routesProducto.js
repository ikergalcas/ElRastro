...
import { getAllProductos, createProducto, editProducto, deleteProducto,getProductosdeUsuario,getProductosDescripcion,
    ...
    getProductosVendidosDeUsuario, valoracionNueva, nuevaImagen, cierrePuja } from '../controllers/ProductoController.js'
...
routerProducto.put('/valoracion/calculoValoracion', valoracionNueva)  //--NUEVO--
routerProducto.put('/:idProducto/nuevaImagen', nuevaImagen) //--NUEVO--
routerProducto.put('/:idProducto/checkeo', cierrePuja) //--NUEVO-- CHECKEAMOS SI HA TERMINADO LA PUJA Y DEVOLVEMOS EL PRODUCTO
